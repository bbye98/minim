...
#             a["id"] == i
#             for a, i in zip(
#                 self.obj.get_albums(self.ALBUM_IDS), self.ALBUM_IDS
#             )
#         )
...
#         assert all(
#             a["type"] == "album" for a in self.obj.get_new_albums()["items"]
#         )

#     def test_get_artist(self):
#         assert (
#             self.obj.get_artist(self.ARTIST_IDS[0])["id"] == self.ARTIST_IDS[0]
#         )
...
#             a["id"] == i
#             for a, i in zip(
#                 self.obj.get_artists(self.ARTIST_IDS), self.ARTIST_IDS
#             )
#         )
...
#         assert (
#             self.obj.get_audiobook(self.AUDIOBOOK_IDS[0])["id"]
...
#         assert (
#             self.obj.get_category("dinner")["id"] == "0JQ5DAqbMKFRY5ok2pxXJ0"
#         )
...
#             c["id"] == i
#             for c, i in zip(
#                 self.obj.get_episodes(self.CHAPTER_IDS, market="US"),
#                 self.CHAPTER_IDS,
#             )
#         )
...
#             e["id"] == i
#             for e, i in zip(
#                 self.obj.get_episodes(self.EPISODE_IDS, market="US"),
#                 self.EPISODE_IDS,
#             )
#         )
...
#         assert isinstance(
#             self.obj.get_playlist_cover_image(self.PLAYLIST_ID), dict
#         )
...
#         assert (
#             self.obj.get_show(self.SHOW_IDS[0], market="US")["id"]
#             == self.SHOW_IDS[0]
#         )
...
#         assert (
#             self.SHOW_IDS[0]
#             in self.obj.get_show_episodes(self.SHOW_IDS[0], market="US")[
#                 "href"
#             ]
#         )
...
#             t["id"] == i
#             for t, i in zip(
#                 self.obj.get_tracks(self.TRACK_IDS), self.TRACK_IDS
#             )
#         )
...
#             for f, i in zip(
#                 self.obj.get_tracks_audio_features(self.TRACK_IDS),
#                 self.TRACK_IDS,
#             )
#         )
