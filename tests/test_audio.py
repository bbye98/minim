...
class TestAudio:
    ...
    def test_convert_flac(self):
        ...
        self.obj_new.convert("flac")
        assert (isinstance(self.obj_new, audio.FLACAudio)
    ...
    def test_convert_mp3(self):
        self.obj_new = copy(self.obj)
        self.obj_new.convert("mp3")
        assert (isinstance(self.obj_new, audio.MP3Audio)
    ...
    def test_convert_mp4_aac(self):
        ...
        assert (isinstance(self.obj_new, audio.MP4Audio)
    ...
    def test_convert_ogg_flac(self):
        ...
        assert (isinstance(self.obj_new, audio.OggAudio)
                and self.obj.bit_depth == self.obj_new.bit_depth
                and self.obj_new.codec == "flac"
                and self.obj.sample_rate == self.obj_new.sample_rate)
    ...
    def test_convert_wave_16bit(self):
        self.obj_new = copy(self.obj)
        self.obj_new.convert("wav", filename="middle_c_16bit", 
