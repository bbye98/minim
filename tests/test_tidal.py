...
#         assert all(
#             i["resource"]["album"]["id"] == self.ALBUM_IDS[0]
#             for i in items["data"]
#         )
...
#         assert (
#             album["data"][0]["resource"]["barcodeId"] == self.ALBUM_BARCODE_ID
#         )
...
#         assert all(
#             a["resource"]["artists"][0]["id"] == self.ARTIST_IDS[0]
...
#         assert (
#             self.obj.get_playlist(self.PLAYLIST_UUID)["uuid"]
#             == self.PLAYLIST_UUID
#         )
